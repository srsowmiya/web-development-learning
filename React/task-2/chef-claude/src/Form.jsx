...
export default function Main() {
    ...
    const [myArray,setMyArray]=useState(["Chicken", "Oregano", "Tomatoes"])

     const ingredientsListItems = myArray.map(ingredient => (
    ...
    function handleSubmit(event) {
        ...
        setMyArray((prevmyArray)=>[...prevmyArray,newIngredient])
    }
